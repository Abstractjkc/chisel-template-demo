...
```sh
git clone git@github.com:Abstractjkc/chisel-template-demo.git
cd chisel-template-demo
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-template-demo'
...
```sh
mill chisel-template-demo.test
```
